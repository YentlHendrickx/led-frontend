...
import { FaLightbulb, FaBars, FaX, FaPaintRoller, FaHouse, FaInfo, FaExplosion } from 'react-icons/fa6';
			...
			<div className="flex flex-col h-1/2 w-full items-center justify-center mt-2 pb-8">
				<div className='mt-4'>
					<Link
						to="/"
						aria-label="Home"
						className="text-6xl text-primary-text hover:text-primary-text-hover"
					>
						<FaLightbulb  />
					</Link>
				</div>
